    ...
    <section id="about" className="py-20 px-4 bg-background">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6 animate-slide-up">About Us</h2>
          <div
          ...
          >
            Team Winning As One is a dedicated team of financial professionals committed to helping individuals and families achieve
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="animate-slide-up" style={{ animationDelay: "0.2s", animationFillMode: "both" }}>
            ...
            <p className="text-foreground/70 mb-4 leading-relaxed">
              Team Winning As One represents a collective of expert advisors based in Great Eastern Malaysia, dedicated to
